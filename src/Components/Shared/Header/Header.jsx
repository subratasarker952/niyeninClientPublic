    ...
    <div className="print:hidden">
      <div className="navbar bg-base-100">
        ...
        <div className="border w-full rounded-lg m-4 flex justify-center  gap-2">
          <NavLink to={'/shop'} className={'p-2 rounded-lg mx-2 hover:bg-black hover:text-white'}>Shop</NavLink>
          <NavLink to={'/about'} className={'p-2 rounded-lg mx-2 hover:bg-black hover:text-white'}>About</NavLink>
          <NavLink to={'/contact'} className={'p-2 rounded-lg mx-2 hover:bg-black hover:text-white'}>Contact</NavLink>
        </div>
